...
function beber(){
    ...
    //ml7.style.background = 'blue'
    hora1.innerHTML = `1 - Bebeu às ${hour}:${min}h`
...
function beber2(){
    ...
    hora2.innerHTML = `2 - Bebeu às ${hour}:${min}h`
}
...
function beber3(){
    ...
    hora3.innerHTML = `3 - Bebeu às ${hour}:${min}h`
}
...
function beber4(){
    ...
    hora4.innerHTML = `4 - Bebeu às ${hour}:${min}h`
}
...
function beber5(){
    ...
    hora5.innerHTML = `5 - Bebeu às ${hour}:${min}h`
}
...
function beber6(){
    ...
    hora6.innerHTML = `6 - Bebeu às ${hour}:${min}h`
}
...
function beber7(){
    ...
    hora7.innerHTML = `7 - Bebeu às ${hour}:${min}h`
}
...
function beber8(){
    ...
    hora8.innerHTML = `8 - Bebeu às ${hour}:${min}h`
}